...
**Organization Policy** (`~/.snowflake/cortex/codex-skill-policy.yaml`):
```yaml
...
1. **Create Organization Policy**
   ...
   cp team-policy.yaml ~/.snowflake/cortex/codex-skill-policy.yaml
   
   # Protect policy file
   chmod 600 ~/.snowflake/cortex/codex-skill-policy.yaml
   ```
