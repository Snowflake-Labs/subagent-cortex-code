...
The cortex-code skill v2.0.0 implements a layered security architecture to protect against unauthorized data access, prompt injection attacks, and other security threats when integrating Codex with Cortex Code CLI.
...
**Logged events**:
- Routing decisions (cortex vs codex)
...
- **Location**: `~/.snowflake/cortex/codex-skill-policy.yaml`
