...
echo "  CORTEXCODE_ALLOW_CODEX_SANDBOX=1 cortexcode-tool --yes \"your question\" --envelope RO"
echo "  (Use after Codex chat approval and network/sandbox approval.)"
echo ""
echo "Verify:"
echo "  cortexcode-tool --version"
echo "  CORTEXCODE_ALLOW_CODEX_SANDBOX=1 cortexcode-tool --yes \"How many databases do I have in Snowflake?\" --envelope RO"
